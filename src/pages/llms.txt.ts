...
export const GET: APIRoute = async () => {
  ...
  const lines: string[] = [
    ...
    `> ${site.description}`,
    '',
    `Wiki for ${site.game.name} (${site.game.platform}, by ${site.game.developer}). Articles cover update guides, expedition walkthroughs, starship and multitool guides, base building, and farming tips.`,
    '',
    '## Articles',
    '',
  ];
