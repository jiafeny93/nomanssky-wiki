...
faq:
  - question: "Are Redux rewards identical to the original expedition's?"
    answer: "Almost always yes — same phases, same milestones, same reward list, which is what makes a rerun worth doing. Occasionally a Redux adds a small bonus reward, as community reports described for the December 2025 Corvette rerun. The announcement post for each rerun is the place to confirm."
  - question: "Do I have to redo milestones if I already finished the original?"
    answer: "Yes. A Redux runs on a fresh save with progress reset to zero, even for players who completed the original run. The payoff for repeat finishers is any new bonus item plus the satisfaction of the clear."
  - question: "When is the next Redux expedition?"
    answer: "Unknown, and anyone quoting a 2026 date is guessing. No rerun has been announced as of August 16, 2026. Based on the 2025 pattern, the holiday season is the most likely window for another block, but that is expectation, not confirmation."
  - question: "What was the biggest Redux season so far?"
    answer: "Holiday Expeditions 2025: five reruns (Beachhead, Titan, Relics, Corvette, Breach) back to back from early November 2025 to mid-January 2026 — roughly ten weeks of continuous expedition content and the most generous recovery window the game has ever had."
  - question: "Can I request a specific expedition to be re-run?"
    answer: "There is no formal request system, but Hello Games has consistently re-run expeditions over the years, and heavily requested classics do tend to circle back. Keep an eye on the news page rather than third-party rumors."
---
