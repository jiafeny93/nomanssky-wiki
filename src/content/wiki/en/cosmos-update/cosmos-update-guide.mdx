...
faq:
  - question: "Is the No Man's Sky Cosmos update free?"
    answer: "Yes. Every major update across No Man's Sky's ten-year history, all forty of them by Hello Games' count, has been free to owners of the base game. Nothing in the Cosmos announcement suggests a change to that model."
  - question: "When does the full Cosmos update arrive?"
    answer: "Cosmos was announced on August 9, 2026 alongside the tenth anniversary celebrations. As of August 16, Hello Games is still publishing details in stages rather than one complete patch note document. Until that document lands, treat any feature list, including ours, as a snapshot of a rollout in progress."
  - question: "Do I need a new save to use Cosmos features?"
    answer: "No update in the game's history has required starting over, and every major system has been retrofitted into existing saves. Cosmos is expected to follow that pattern, so your current save should gain access to the new features directly."
  - question: "Can I still warp the old way?"
    answer: "The announcement describes interstellar free flight as an option, which strongly implies the hyperdrive and warp cell loop remains in place for players who want fast, efficient jumps. Expect both systems to coexist until patch notes say otherwise."
  - question: "Does Cosmos connect to Light No Fire?"
    answer: "No direct gameplay connection has been announced. Light No Fire is Hello Games' next, separately developed title that Murray mentioned again in his anniversary letter. Cosmos is a No Man's Sky update first and foremost."
---
...
<StatBar
  items={[
    { value: 'Free', label: 'For every existing owner, like all updates' },
    { value: '40+', label: 'Major updates shipped across 10 years' },
    { value: 'Aug 9', label: '2026 announcement date' },
    { value: 'Staged', label: 'Patch notes still rolling out' },
  ]}
/>

<Callout type="info" title="Details are still landing in stages">
  Cosmos patch notes are being released progressively, so some mechanics below are confirmed
  and others only reported. Confirmed facts are stated plainly; everything thinner than that
  is flagged inline so you can tell the difference.
</Callout>
